...
import SingleScanResult from "../dashboard/scan-results/single-scan-result";
import Paragraph from "../text/paragraph";
import { ToastAction } from "../ui/toaster/toast";
import { toast } from "../ui/toaster/use-toast";
import SingleScanResultMythril from "@/app/(dashboard)/dashboard/single/mithril-scan-result";
...
const InputFile = () => {
  ...
  return (
    ...
    "
      ...
      {/* <div>
        <SingleScanResultMythril item={scanResult ?? []} />
      </div> */}
    </>
  );
};
