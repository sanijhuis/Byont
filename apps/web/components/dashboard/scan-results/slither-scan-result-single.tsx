...
const SlitherScanResultSingle = ({ data }: any) => {
  ...
  if (data !== null && data.results.detectors?.length) {
    return (
      <>
        <>
          <Accordion type="single" collapsible>
            {data.results.detectors.map((issue: any, index: number) => (
              <AccordionItem
...
export default SlitherScanResultSingle;
