...
//   useEffect(() => {
//     if (provider) {
//       setContract(new ethers.Contract(contractAddress, contractAbi, provider.getSigner()));
//     }
//   }, [provider]);
...
// 	  requestAccount();
//       // Mint the NFT
//       const tx = await contract.safeMint(window.ethereum.selectedAddress, ipfsHash);
//       await tx.wait();
//       return ipfsHash;
//     } else {
